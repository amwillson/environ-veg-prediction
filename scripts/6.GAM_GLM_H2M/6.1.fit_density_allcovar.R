...
## Output: /Volumes/FileBackup/SDM_bigdata/out/gam/H/density/allcovar.RData
...
## Output: /Volumes/FileBackup/SDM_bigdata/out/gam/H/density/allcovar_4k.RData
...
# Fit GAM
density_gam_H_allcovar <- mvgam::mvgam(formula = total_density ~
                                         s(clay) +
                                         s(sand) +
                                         s(silt) +
                                         s(caco3) +
                                       ...
                                       family = mvgam::lognormal()) # Takes about 40 minutes
...
density_gam_H_allcovar_4k <- mvgam::mvgam(formula = total_density ~
                                            s(clay, k = 5) +
                                            s(sand, k = 5) +
                                            s(silt, k = 5) +
                                            s(caco3, k = 5) +
...
# Save
save(density_gam_H_allcovar_4k,
     file = '/Volumes/FileBackup/SDM_bigdata/out/gam/H/density/allcovar_4k.RData')
...
partials <- mvgam::drawDotmvgam(density_gam_H_allcovar)
...
# Get partial effects plots
partials <- mvgam::drawDotmvgam(density_gam_H_allcovar_4k)
...
ggplot2::ggplot() +
  ...
  ggplot2::geom_ribbon(ggplot2::aes(x = clay_data$clay,
                       ...
                       alpha = 0.2) +
  ggplot2::xlab('Soil % clay') + ggplot2::ylab('Effect') +
  ggplot2::ylim(c(-18.2, 18.71)) +
  ggplot2::theme_minimal() +
  ggplot2::theme(axis.title = ggplot2::element_text(size = 10),
                 axis.text = ggplot2::element_text(size = 8))

ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_4k_covar_partial_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/all_covar_4k_partial_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
