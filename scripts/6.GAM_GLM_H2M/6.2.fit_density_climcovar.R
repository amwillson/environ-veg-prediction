...
# Fit GAM
density_gam_H_climcovar <- mvgam::mvgam(formula = total_density ~
                                          s(ppt_sum) +
                                          s(tmean_mean) +
                                          s(ppt_cv) +
                                          s(tmean_sd) +
                                        ...
                                        family = mvgam::lognormal()) # Takes about 29 minutes
...
density_gam_H_climcovar_4k <- mvgam::mvgam(formula = total_density ~
                                             s(ppt_sum, k = 5) +
                                             s(tmean_mean, k = 5) +
                                             s(ppt_cv, k = 5) +
                                             s(tmean_sd, k = 5) +
...
partials <- mvgam::drawDotmvgam(density_gam_H_climcovar)
...
# Get partial effects plots
partials <- mvgam::drawDotmvgam(density_gam_H_climcovar_4k)
...
ggplot2::ggplot() +
  ...
  ggplot2::xlab('Total annual precipitation (mm/year)') +
  ggplot2::ylab('Effect') +
  ggplot2::ylim(c(-15.03, 17.02)) +
  ggplot2::theme_minimal() +
  ggplot2::theme(axis.title = ggplot2::element_text(size = 10),
                 axis.text = ggplot2::element_text(size = 8))

ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/clim_covar_4k_partial_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/clim_covar_4k_partial_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/clim_covar_4k_partial_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/clim_covar_4k_partial_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/clim_covar_4k_covar_partial_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/clim_covar_4k_partial_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/fit/clim_covar_4k_partial_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
