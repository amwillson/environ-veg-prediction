...
## Output: /Volumes/FileBackup/SDM_bigdata/out/gjam/H/abundance/xycovar.RData
...
# Run model
abund_gjam_H_xycovar <- gjam::gjam(formula = ~ x + y +
...
# Simple plots
gjam::gjamPlot(abund_gjam_H_xycovar)

# Save
save(abund_gjam_H_xycovar,
     file = '/Volumes/FileBackup/SDM_bigdata/out/gjam/H/abundance/xycovar.RData')
...
bFacGibbs <- abund_gjam_H_xycovar$chains$bFacGibbs
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/H/abundance/fit/xy_covar_covariates.png',
