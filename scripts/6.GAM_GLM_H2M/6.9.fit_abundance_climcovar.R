...
# Run model
abund_gjam_H_climcovar <- gjam::gjam(formula = ~ pptsum + tmean + pptcv +
...
bFacGibbs <- abund_gjam_H_climcovar$chains$bFacGibbs
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/H/abundance/fit/clim_covar_covariates.png',
