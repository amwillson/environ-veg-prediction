...
## From 6.5.density_historical_predictions.R
...
## grid cells using the main model with climate and soil covariates
## From 6.6.density_modern_predictions.R
...
load('out/gam/H/density/predicted_historical_gam1.RData')
# Load historical predictions from model 2
load('out/gam/H/density/predicted_historical_gam2.RData')
# Load historical predictions from model 3
load('out/gam/H/density/predicted_historical_gam3.RData')

# Load historical predictions from model 1 with lower basis dimensionality
load('out/gam/H/density/predicted_historical_gam1_4k.RData')
# Load historical predictions from model 2 with lower basis dimensionality
load('out/gam/H/density/predicted_historical_gam2_4k.RData')
# Load historical predictions from model 3 with lower basis dimensionality
load('out/gam/H/density/predicted_historical_gam3_4k.RData')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_pred_space_allcovar.png',
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_pred_space_allcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_pred_space_redcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_pred_space_redcovar_4k.png',
                width = 10, height = 10, units = 'cm')

# Plot predictions over space with all three models
pred_historical |>
  tidyr::pivot_longer(cols = c(estimate_gam1, estimate_gam2, estimate_gam3),
                      names_to = 'fit',
                      values_to = 'predicted') |>
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_predvobs_allcovar_cutoff.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_predvobs_allcovar_4k_cutoff.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_predvobs_redcovar_cutoff.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_predvobs_redcovar_4k_cutoff.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_pred-obs_allcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_pred-obs_allcovar_4k.png',
                width = 10, height = 10, units = 'cm')

# Model with uncorrelated covariates
pred_historical |>
  dplyr::mutate(sign = dplyr::if_else(diff3 < 0, -1, 1),
                sqrtdiff1 = sqrt(abs(diff3)),
                diff1_trans = sqrtdiff1 * sign) |>
  ggplot2::ggplot() +
  ggplot2::geom_sf(data = states, color = NA, fill = 'grey85') +
  ggplot2::geom_tile(ggplot2::aes(x = x, y = y, fill = diff1_trans)) +
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_pred-obs_redcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2h_pred-obs_redcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Combine
historical_cors <- c(corr1, corr2, corr3)
historical_cors_4k <- c(corr1_4k, corr2_4k, corr3_4k)
...
historical_cors$model <- historical_cors_4k$model <-
  c('Climate + soil', 'Climate only', 'Uncorrelated covariates')
...
load('out/gam/H/density/predicted_modern_gam1.RData')
# Load modern predictions from model 2
load('out/gam/H/density/predicted_modern_gam2.RData')
# Load modern predictions from model 3
load('out/gam/H/density/predicted_modern_gam3.RData')

# Load modern predictions from model 1 with lower basis dimension
load('out/gam/H/density/predicted_modern_gam1_4k.RData')
# Load modern predictions from model 2 with lower basis dimension
load('out/gam/H/density/predicted_modern_gam2_4k.RData')
# Load modern predictions from model 3 with lower basis dimension
load('out/gam/H/density/predicted_modern_gam3_4k.RData')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_pred_space_allcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_pred_space_allcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_pred_space_redcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_pred_space_redcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_predvobs_allcovar_cutoff.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_predvobs_allcovar_4k_cutoff.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_predvobs_redcovar_cutoff.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_predvobs_redcovar_4k_cutoff.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_pred-obs_allcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_pred-obs_allcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_pred-obs_redcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_pred-obs_redcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/h2m_pred-obs_facets.png',
                width = 20, height = 20, units = 'cm')
...
# Combine
modern_cors <- c(corr1, corr2, corr3)
modern_cors_4k <- c(corr1_4k, corr2_4k, corr3_4k)
...
colnames(pred_historical) <- c('x', 'y', 'estimate_gam1_H',
                               'estimate_gam2_H', 'estimate_gam3_H',
                               'diff1_H', 'diff2_H', 'diff3_H')
colnames(pred_historical_4k) <- c('x', 'y', 'estimate_gam1_4k_H',
                                  'estimate_gam2_4k_H', 'estimate_gam3_4k_H',
                                  'diff1_H', 'diff2_H', 'diff3_H')
colnames(pred_modern) <- c('x', 'y', 'estimate_gam1_M',
                           'estimate_gam2_M', 'estimate_gam3_M',
                           'diff1_M', 'diff2_M', 'diff3_M')
colnames(pred_modern_4k) <- c('x', 'y', 'estimate_gam1_4k_M',
                              'estimate_gam2_4k_M', 'estimate_gam3_4k_M',
                              'diff1_M', 'diff2_M', 'diff3_M')
...
preds |>
  dplyr::mutate(sign = dplyr::if_else(pred_diff1 < 0, -1, 1),
                sqrtdiff = sqrt(abs(pred_diff1)),
                diff_trans = sqrtdiff * sign) |>
  ggplot2::ggplot() +
  ggplot2::geom_sf(data = states, color = NA, fill = 'grey85') +
  ggplot2::geom_tile(ggplot2::aes(x = x, y = y, fill = diff_trans)) +
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred_allcovar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred_allcovar_4k.png',
                height = 10, width = 10, units = 'cm')

# Plot difference in prediction in space with model with uncorrelated covariates
preds |>
  dplyr::mutate(sign = dplyr::if_else(pred_diff3 < 0, -1, 1),
                sqrtdiff = sqrt(abs(pred_diff3)),
                diff_trans = sqrtdiff * sign) |>
  ggplot2::ggplot() +
  ggplot2::geom_sf(data = states, color = NA, fill = 'grey85') +
  ggplot2::geom_tile(ggplot2::aes(x = x, y = y, fill = diff_trans)) +
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred_redcovar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred_redcovar_4k.png',
                height = 10, width = 10, units = 'cm')

# Plot difference in prediction in space with all models
preds |>
  tidyr::pivot_longer(cols = pred_diff1:pred_diff3,
                      names_to = 'fit',
                      values_to = 'pred_diff') |>
  dplyr::mutate(fit = dplyr::if_else(fit == 'pred_diff1',
                ...
                fit = dplyr::if_else(fit == 'pred_diff3',
                                     'Uncorrelated\ncovariates',
                                     fit)) |>
  dplyr::mutate(sign = dplyr::if_else(pred_diff < 0, -1, 1),
                sqrtdiff = sqrt(abs(pred_diff)),
                diff_trans = sqrtdiff * sign) |>
  ggplot2::ggplot() +
  ggplot2::geom_sf(data = states, color = NA, fill = 'grey85') +
  ggplot2::geom_tile(ggplot2::aes(x = x, y = y, fill = diff_trans)) +
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred_facet.png',
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred_facet_4k.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_allcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_allcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_redcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_redcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_allcovar2.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_allcovar2_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_redcovar2.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_redcovar2_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_allcovar3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_allcovar3_4k.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_redcovar3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_pred-obs_redcovar3_4k.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_which_better_accuracy_allcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_which_better_accuracy_allcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_which_better_accuracy_redcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_which_better_accuracy_redcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_change_modern_better_allcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_change_modern_better_allcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_change_modern_better_redcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_change_modern_better_redcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_change_historic_better_allcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_change_historic_better_allcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_change_historic_better_redcovar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/comp_change_historic_better_redcovar_4k.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/pred_corr_comparison.png',
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gam/H/density/pred/pred_corr_comparison_4k.png',
                height = 8, width = 12, units = 'cm')
