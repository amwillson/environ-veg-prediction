...
# Load COND tables
IL_COND <- readr::read_csv('data/raw/FIA/IL_COND.csv')
IN_COND <- readr::read_csv('data/raw/FIA/IN_COND.csv')
MI_COND <- readr::read_csv('data/raw/FIA/MI_COND.csv')
MN_COND <- readr::read_csv('data/raw/FIA/MN_COND.csv')
WI_COND <- readr::read_csv('data/raw/FIA/WI_COND.csv')
