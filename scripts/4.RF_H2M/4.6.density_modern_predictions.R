...
## covariates
## From 4.1.fit_density_allcovar.R
...
## covariates
## From 4.2.fit_density_climcovar.R
...
## of covariates
## From 4.3.fit_density_redcovar.R
...
## From 4.4.fit_density_xycovar.R
...
## Output: out/rf/H/density/predicted_modern_rf1.RData
...
## Output: out/rf/H/density/predicted_modern_rf2.RData
## Dataframe of observed vegetation, soil, and climate data and
## predicted modern total stem density from the out-of-sample 
## grid cells using the alternate model with only climate covariates
## Used in 4.7.density_figures.R

## Output: out/rf/H/density/predicted_modern_rf3.RData
## Dataframe of observed vegetation, soil, and climate data and
## predicted modern total stem density from the out-of-sample 
## grid cells using the alternate model with only the reduced set of covariates
## Used in 4.7.density_figures.R

## Output: out/rf/H/density/predicted_modern_rf4.RData
## Dataframe of observed vegetation, soil, and climate data and
## predicted modern total stem density from the out-of-sample 
...
save(pred_modern_rf1,
     file = 'out/rf/H/density/predicted_modern_rf1.RData')
...
save(pred_modern_rf2,
     file = 'out/rf/H/density/predicted_modern_rf2.RData')
...
save(pred_modern_rf3,
     file = 'out/rf/H/density/predicted_modern_rf3.RData')
...
save(pred_modern_rf4,
     file = 'out/rf/H/density/predicted_modern_rf4.RData')
