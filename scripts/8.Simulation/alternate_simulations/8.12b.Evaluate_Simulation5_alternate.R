#### Analyzing Simulation 5- alternate
...
load('out/simulation/sim5_alt.RData')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/simulations/sim_5_alt_pred_1.png')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/simulations/sim_5_alt_pred_final.png')
