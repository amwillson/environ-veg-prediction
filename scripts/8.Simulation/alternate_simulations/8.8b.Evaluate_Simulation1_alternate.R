#### Analyzing Simulation 1- alternate
#### Fitting models and predicting stem density
#### Assumptions for Simulation 1 are as follows:
...
# Load output from Simulation 1
load('out/simulation/sim1_alt.RData')
...
fit_glm <- glm(formula = density ~ var1 + var2,
               data = simulation_in1,
...
fit_gam <- mvgam::mvgam(formula = density ~
                          s(var1, k = 3) + # reducing k for convergence 
                          s(var2, k = 3),  # ""
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/simulations/sim_1_alt_pred_1.png')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/simulations/sim_1_alt_pred_final.png')
