...
load('out/simulation/sim1.RData')
...
# Plot together
cowplot::plot_grid(p_glm_1, p_rf_1, p_gam_1, nrow = 1)

# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                file = 'figures/simulations/sim_1_pred_1.png')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                file = 'figures/simulations/sim_1_pred_final.png')
