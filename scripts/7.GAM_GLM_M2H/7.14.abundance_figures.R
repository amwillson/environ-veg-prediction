...
## Input: out/gjam/M/abundance/predicted_historical_gjam1.RData
...
load('out/gjam/M/abundance/predicted_historical_gjam1.RData')
# Load historical predictions from model 2
load('out/gjam/M/abundance/predicted_historical_gjam2.RData')
# Load historical predictions from model 3
load('out/gjam/M/abundance/predicted_historical_gjam3.RData')
# Load historical predictions from model 4
load('out/gjam/M/abundance/predicted_historical_gjam4.RData')
...
pred_historical_gjam1 <- dplyr::select(pred_historical_gjam1,
                                       x, y,
                                       dplyr::all_of(obs_cols),
                                       dplyr::all_of(pred_cols1))
pred_historical_gjam2 <- dplyr::select(pred_historical_gjam2,
                                       x, y,
                                       dplyr::all_of(obs_cols),
                                       dplyr::all_of(pred_cols2))
pred_historical_gjam3 <- dplyr::select(pred_historical_gjam3,
                                       x, y,
                                       dplyr::all_of(obs_cols),
                                       dplyr::all_of(pred_cols3))
pred_historical_gjam4 <- dplyr::select(pred_historical_gjam4,
                                       x, y,
                                       dplyr::all_of(obs_cols),
                                       dplyr::all_of(pred_cols4))

# Combine dataframes
pred_historical <- pred_historical_gjam1 |>
  dplyr::full_join(y = pred_historical_gjam2,
                   by = c('x', 'y', obs_cols)) |>
  dplyr::full_join(y = pred_historical_gjam3,
                   by = c('x', 'y', obs_cols)) |>
  dplyr::full_join(y = pred_historical_gjam4,
                   by = c('x', 'y', obs_cols))

# Check that rows combined correctly
nrow(pred_historical) == nrow(pred_historical_gjam1) # should be TRUE
nrow(pred_historical) == nrow(pred_historical_gjam2) # should be TRUE
nrow(pred_historical) == nrow(pred_historical_gjam3) # should be TRUE
nrow(pred_historical) == nrow(pred_historical_gjam4) # should be TRUE
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_ash.png',
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_basswood.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_beech.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_birch.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_cherry.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_dogwood.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_elm.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_fir.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_hemlock.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_hickory.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_ironwood.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_maple.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_oak.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_pine.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_spruce.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_tamarack.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_walnut.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_oh.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_gum.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_cedar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred_space_allcovar_poplar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_ash.png',
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_basswood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_beech.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_birch.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_cherry.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_dogwood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_elm.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_fir.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_hemlock.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_hickory.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_ironwood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_maple.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_oak.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_pine.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_spruce.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_tamarack.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_walnut.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_oh.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_gum.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_cedar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_predvobs_allcovar_poplar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_ash.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_beech.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_birch.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_cherry.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_dogwood.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_elm.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_fir.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_hemlock.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_hickory.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_ironwood.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_maple.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_oak.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_pine.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_spruce.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_tamarack.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_walnut.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_oh.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_gum.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_cedar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2h_pred-obs_allcovar_poplar.png',
                width = 10, height = 10, units = 'cm')
...
load('out/gjam/M/abundance/predicted_modern_gjam1.RData')
# Load modern predictions from model 2
load('out/gjam/M/abundance/predicted_modern_gjam2.RData')
# Load modern predictions from model 3
load('out/gjam/M/abundance/predicted_modern_gjam3.RData')
# Load modern predictions from model 4
load('out/gjam/M/abundance/predicted_modern_gjam4.RData')

#### 7. Process modern predictions ####

# Ungroup dataframes
pred_modern_gjam1 <- dplyr::ungroup(pred_modern_gjam1)
pred_modern_gjam2 <- dplyr::ungroup(pred_modern_gjam2)
pred_modern_gjam3 <- dplyr::ungroup(pred_modern_gjam3)
pred_modern_gjam4 <- dplyr::ungroup(pred_modern_gjam4)

# Select only necessary columns for each dataframe
pred_modern_gjam1 <- dplyr::select(pred_modern_gjam1,
                                   x, y,
                                   dplyr::all_of(obs_cols),
                                   dplyr::all_of(pred_cols1))
pred_modern_gjam2 <- dplyr::select(pred_modern_gjam2,
                                   x, y,
                                   dplyr::all_of(obs_cols),
                                   dplyr::all_of(pred_cols2))
pred_modern_gjam3 <- dplyr::select(pred_modern_gjam3,
                                   x, y,
                                   dplyr::all_of(obs_cols),
                                   dplyr::all_of(pred_cols3))
pred_modern_gjam4 <- dplyr::select(pred_modern_gjam4,
                                   x, y,
                                   dplyr::all_of(obs_cols),
                                   dplyr::all_of(pred_cols4))

# Combine dataframes
pred_modern <- pred_modern_gjam1 |>
  dplyr::full_join(y = pred_modern_gjam2,
                   by = c('x', 'y', obs_cols)) |>
  dplyr::full_join(y = pred_modern_gjam3,
                   by = c('x', 'y', obs_cols)) |>
  dplyr::full_join(y = pred_modern_gjam4,
                   by = c('x', 'y', obs_cols))

# Check that rowss combined correctly
nrow(pred_modern) == nrow(pred_modern_gjam1) # should be TRUE
nrow(pred_modern) == nrow(pred_modern_gjam2) # should be TRUE
nrow(pred_modern) == nrow(pred_modern_gjam3) # should be TRUE
nrow(pred_modern) == nrow(pred_modern_gjam4) # should be TRUE
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_ash.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_basswood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_beech.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_birch.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_cherry.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_dogwood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_elm.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_fir.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_hemlock.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_hickory.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_ironwood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_maple.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_oak.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_pine.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_spruce.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_tamarack.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_walnut.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_oh.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_gum.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_cedar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred_space_allcovar_poplar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_ash.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_basswood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_beech.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_birch.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_cherry.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_dogwood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_elm.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_fir.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_hemlock.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_hickory.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_ironwood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_maple.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_oak.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_pine.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_spruce.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_tamarack.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_walnut.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_oh.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_gum.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_cedar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_predvobs_allcovar_poplar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_ash.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_basswood.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_beech.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_birch.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_cherry.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_dogwood.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_elm.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_fir.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_hemlock.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_hickory.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_ironwood.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_maple.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_oak.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_pine.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_spruce.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_tamarack.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_walnut.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_oh.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_gum.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_cedar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/m2m_pred-obs_allcovar_poplar.png',
                width = 10, height = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_ash.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_basswood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_beech.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_birch.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_cherry.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_dogwood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_elm.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_fir.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_hemlock.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_hickory.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_ironwood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_maple.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_oak.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_pine.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_spruce.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_tamarack.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_walnut.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_oh.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_gum.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_cedar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_allcovar_poplar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_ash.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_basswood.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_beech.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_birch.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_cherry.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_dogwood.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_elm.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_fir.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_hemlock.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_hickory.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_ironwood.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_maple.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_oak.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_pine.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_spruce.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_tamarack.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_walnut.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_oh.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_gum.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_cedar.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred_facet_poplar.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_ash.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_basswood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_beech.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_birch.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_cherry.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_dogwood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_elm.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_fir.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_hemlock.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_hickory.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_ironwood.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_maple.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_oak.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_pine.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_spruce.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_tamarack.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_walnut.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_oh.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_gum.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_cedar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_poplar.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_ash2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_basswood2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_beech2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_birch2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_cherry2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_dogwood2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_elm2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_fir2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_hemlock2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_hickory2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_ironwood2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_maple2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_oak2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_pine2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_spruce2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_tamarack2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_walnut2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_oh2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_gum2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_cedar2.png',
                height = 10, width = 10, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_poplar2.png',
                height = 10, width = 10, units = 'cm')

## Plot change with direction and whether density was over or underpredicted
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_ash3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_basswood3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_beech3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_birch3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_cherry3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_dogwood3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_elm3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_fir3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_hemlock3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_hickory3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_ironwood3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_maple3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_oak3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_pine3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_spruce3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_tamarack3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_oh3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_gum3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_cedar3.png',
                height = 20, width = 20, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/comp_pred-obs_allcovar_poplar3.png',
                height = 20, width = 20, units = 'cm')
...
## Plot comparison of corrleation coefficient
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/pred_corr_comparison.png',
                height = 40, width = 40, units = 'cm')

## Plot comparison with only the main model
both_cors |>
  tidyr::pivot_longer(c(corr1_historical, corr1_modern),
                      names_to = 'fit_period',
                      values_to = 'correlation') |>
  dplyr::mutate(period = sub(pattern = '.*_', replacement = '', x = fit_period),
                period = dplyr::if_else(period == 'historical', 'Historical', 'Modern'),
                fit = sub(pattern = '_.*', replacement = '', x = fit_period)) |>
  ggplot2::ggplot() +
  ggplot2::geom_bar(ggplot2::aes(x = fit, y = correlation,
                                 fill = period),
                    stat = 'identity',
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/gjam/M/abundance/pred/pred_corr_comparison_allcovar.png',
                height = 40, width = 40, units = 'cm')
