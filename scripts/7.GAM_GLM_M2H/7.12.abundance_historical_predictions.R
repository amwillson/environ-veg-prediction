...
## from MODERN fitted GLMs

## NOTE that models were saved on an external hard drive in
## steps 7-8 through 7-11. They must be loaded from the external
...
## Input: /Volumes/FileBackup/SDM_bigdata/out/gjam/M/abundance/allcovar.RData
...
## Output: out/gjam/M/abundance/predicted_historical_gjam1.RData
...
## Used in 7.14.abundance_figures.R

## Output: out/gjam/M/abundance/predicted_historical_gjam2.RData
## Dataframe of observed vegetation, soil, and climate data and
## predicted historical relative abundances from the out-of-sample 
## grid cells using the alternate model with only climate covariates
## Used in 7.14.abundance_figures.R

## Output: out/gjam/M/abundance/predicted_historical_gjam3.RData
## Dataframe of observed vegetation, soil, and climate data and
## predicted historical relative abundances from the out-of-sample 
## grid cells using the alternate model with only the reduced set of covariates
## Used in 7.14.abundance_figures.R

## Output: out/gjam/M/abundance/predicted_historical_gjam4.RData
## Dataframe of observed vegetation, soil, and climate data and
## predicted historical relative abundances from the out-of-sample 
...
load('/Volumes/FileBackup/SDM_bigdata/out/gjam/M/abundance/allcovar.RData')
# Load model with climate covariates
load('/Volumes/FileBackup/SDM_bigdata/out/gjam/M/abundance/climcovar.RData')
# Load model with reduced covariates
load('/Volumes/FileBackup/SDM_bigdata/out/gjam/M/abundance/redcovar.RData')
# Load model with all covariates plus coordinates
load('/Volumes/FileBackup/SDM_bigdata/out/gjam/M/abundance/xycovar.RData')
...
pred_gjam1 <- gjam::gjamPredict(output = abund_gjam_M_allcovar,
...
save(pred_historical_gjam1,
     file = 'out/gjam/M/abundance/predicted_historical_gjam1.RData')

# Make prediction with model 2
pred_gjam2 <- gjam::gjamPredict(output = abund_gjam_M_climcovar,
                                newdata = new_datalist)
...
save(pred_historical_gjam2,
     file = 'out/gjam/M/abundance/predicted_historical_gjam2.RData')

# Make prediction with model 3
pred_gjam3 <- gjam::gjamPredict(output = abund_gjam_M_redcovar,
                                newdata = new_datalist)
...
save(pred_historical_gjam3,
     file = 'out/gjam/M/abundance/predicted_historical_gjam3.RData')

# Make prediction with model 4
pred_gjam4 <- gjam::gjamPredict(output = abund_gjam_M_xycovar,
                                newdata = new_datalist)
...
save(pred_historical_gjam4,
     file = 'out/gjam/M/abundance/predicted_historical_gjam4.RData')
