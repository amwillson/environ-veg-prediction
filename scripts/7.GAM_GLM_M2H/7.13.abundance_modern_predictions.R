...
## Output: out/gjam/M/abundance/predicted_modern_gjam2.RData
## Dataframe of observed vegetation, soil, and climate data and
## predicted modern relative abundances from the out-of-sample 
## grid cells using the alternate model with only climate covariates
## Used in 7.14.abundance_figures.R

## Output: out/gjam/M/abundance/predicted_modern_gjam3.RData
## Dataframe of observed vegetation, soil, and climate data and
## predicted modern relative abundances from the out-of-sample 
## grid cells using the alternate model with only the reduced set of covariates
## Used in 7.14.abundance_figures.R

## Output: out/gjam/M/abundance/predicted_modern_gjam4.RData
## Dataframe of observed vegetation, soil, and climate data and
## predicted modern relative abundances from the out-of-sample 
...
save(pred_modern_gjam1,
     file = 'out/gjam/M/abundance/predicted_modern_gjam1.RData')
...
save(pred_modern_gjam2,
     file = 'out/gjam/M/abundance/predicted_modern_gjam2.RData')
...
save(pred_modern_gjam3,
     file = 'out/gjam/M/abundance/predicted_modern_gjam3.RData')
...
save(pred_modern_gjam4,
     file = 'out/gjam/M/abundance/predicted_modern_gjam4.RData')
