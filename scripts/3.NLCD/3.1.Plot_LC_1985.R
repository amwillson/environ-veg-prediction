...
## Choosing 1985 simply because it's the earliest year
## of the time series
...
## Input: /Volumes/FileBackup/SDM_bigdata/NLCD_4huSzSwuyTP2jbX8It5J/Annual_NLCD_LndCov_1985_CU_C1V0_4huSzSwuyTP2jbX8It5J.tiff
## NLCD raster for Upper Michigan
## Downloaded from https://www.mrlc.gov/viewer/

## Input: /Volumes/FileBackup/SDM_bigdata/NLCD_9ZXc4bOuLO4vdXXqNbSO/Annual_NLCD_LndCov_1985_CU_C1V0_9ZXc4bOuLO4vdXXqNbSO.tiff
## NLCD raster for northern Minnesota
## Downloaded from https://www.mrlc.gov/viewer/

## Input: /Volumes/FileBackup/SDM_bigdata/NLCD_b5GgTPUIDunbqFkYYgzP/Annual_NLCD_LndCov_1985_CU_C1V0_b5GgTPUIDunbqFkYYgzP.tiff
...
## Input: /Volumes/FileBackup/SDM_bigdata/NLCD_To6BNjHHiRaLtuUjkReu/Annual_NLCD_LndCov_1985_CU_C1V0_To6BNjHHiRaLtuUjkReu.tiff
## NLCD raster for Lower Michigan
## Downloaded from https://www.mrlc.gov/viewer/

## Input: /Volumes/FileBackup/SDM_bigdata/NLCD_v4ffXdyI2mi2ILtcwIQW/Annual_NLCD_LndCov_1985_CU_C1V0_v4ffXdyI2mi2ILtcwIQW.tiff
