...
## Use nodesize = 1, mtry = 3 because there is no difference

#### 3. Fit random forest ####

# Fit random forest
abund_rf_M_allcovar <- randomForestSRC::rfsrc(formula = Multivar(Ash, Basswood, Beech,
                                                                 Birch, Cherry, Dogwood,
                                                                 Elm, Fir, Hemlock,
                                                                 Hickory, Ironwood, Maple,
                                                                 Oak, Pine, Spruce,
...
var_imp <- randomForestSRC::subsample(obj = abund_rf_M_allcovar,
                                      B = 100)
...
## total annual precipitation, soil % clay
## Not including the correlated temperature variables

# Find minimum depth of each variable across trees
var_select <- randomForestSRC::var.select(object = abund_rf_M_allcovar,
...
## annual temperature, total annual precipitation, temperature
## seasonality, and soil % clay
## Skipping correlated temperature variables
...
## Soil % clay
# Partial effect
clay_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                               xvar.names = 'clay',
                                               m.target = 'Ash',
                                               partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_clay.png',
                height = 8, width = 9.5, units = 'cm')

## Soil % sand
sand_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                               xvar.names = 'sand',
                                               m.target = 'Ash',
                                               partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_sand.png',
                height = 8, width = 9.5, units = 'cm')

## Soil % silt
silt_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                               xvar.names = 'silt',
                                               m.target = 'Ash',
                                               partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_silt.png',
                height = 8, width = 9.5, units = 'cm')

## Soil calcium carbonate concentration
caco3_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                                xvar.names = 'caco3',
                                                m.target = 'Ash',
                                                partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_caco3.png',
                height = 8, width = 9.5, units = 'cm')

## Soil available water content
awc_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                              xvar.names = 'awc',
                                              m.target = 'Ash',
                                              partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_awc.png',
                height = 8, width = 9.5, units = 'cm')

## % of grid cell in a floodplain
flood_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                                xvar.names = 'flood',
                                                m.target = 'Ash',
                                                partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_flood.png',
                height = 8, width = 9.5, units = 'cm')

## Total annual precipitation
ppt_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                              xvar.names = 'ppt_sum',
                                              m.target = 'Ash',
                                              partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')

## Mean annual temperature
tmean_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')

## Precipitation seasonality
ppt_cv_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                                 xvar.names = 'ppt_cv',
                                                 m.target = 'Ash',
                                                 partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')

## Temperature seasonality
tmean_sd_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                                   xvar.names = 'tmean_sd',
                                                   m.target = 'Ash',
                                                   partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')

## Minimum annual temperature
tmin_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                               xvar.names = 'tmin',
                                               m.target = 'Ash',
                                               partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_tmin.png',
                height = 8, width = 9.5, units = 'cm')

## Maximum annual temperature
tmax_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                               xvar.names = 'tmax',
                                               m.target = 'Ash',
                                               partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_tmax.png',
                height = 8, width = 9.5, units = 'cm')

## Maximum annual vapor pressure deficit
vpd_partial <- randomForestSRC::plot.variable(x = abund_rf_M_allcovar,
                                              xvar.names = 'vpdmax',
                                              m.target = 'Ash',
                                              partial = TRUE)
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ash_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_basswood_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_beech_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_birch_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cherry_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_dogwood_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_elm_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_fir_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hemlock_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_hickory_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_ironwood_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_maple_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oak_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_pine_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_spruce_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_tamarack_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_walnut_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_oh_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gumm_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_gum_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_cedar_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
...
# Save
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_clay.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_sand.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_silt.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_caco3.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_awc.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_flood.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_ppt_sum.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_tmean_mean.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_ppt_cv.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_tmean_sd.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_tmin.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_tmax.png',
                height = 8, width = 9.5, units = 'cm')
...
ggplot2::ggsave(plot = ggplot2::last_plot(),
                filename = 'figures/rf/M/abundance/fit/all_covar_partial_poplar_vpdmax.png',
                height = 8, width = 9.5, units = 'cm')
