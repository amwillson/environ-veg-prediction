...
## Input: out/rf/M/density/predicted_historical_rf1.RData
...
## From 5.5.density_historical_predictions.R

## Input: out/rf/M/density/predicted_historical_rf2.RData
## Dataframe with observed historical out-of-sample vegetation, soil,
## and climate data as well as predicted historical total
## stem density from alternate model with only climate covariates
## From 5.5.density_historical_predictions.R

## Input: out/rf/M/density/predicted_historical_rf3.RData
## Dataframe with observed historical out-of-sample vegetation, soil,
## and climate data as well as predicted historical total
...
## Input: out/rf/M/density/predicted_historical_rf4.RData
## Dataframe with observed historical out-of-sample vegetation, soil,
## and climate data as well as predicted historical total
